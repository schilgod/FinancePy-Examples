...
##########################################################################
    ...
    print("STOCK PRICE", "VALUE_BS", "VALUE_MC", "TIME")
    ...
    for stockPrice in stockPrices:
        ...
        duration = end - start
        print(stockPrice, value, valueMC, duration)
...
##########################################################################
    ...
    for stockPrice in stockPrices:
        ...
        rho = 999
        print(stockPrice, value, delta, vega, theta, rho)
...
##########################################################################
    ...
    print("STOCK PRICE", "VALUE_BS", "VOL_IN", "IMPLD_VOL")
    ...
    for stockPrice in stockPrices:
        ...
        print(stockPrice, value, volatility, impliedVol)
