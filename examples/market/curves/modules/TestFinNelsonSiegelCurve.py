...
def test_FinNelsonSiegelCurve():
    ...
    print(beta1, beta2, beta3, zeroRates1)
    ...
    print(beta1, beta2, beta3, zeroRates2)
    ...
    print(beta1, beta2, beta3, zeroRates3)
    ...
    print(beta1, beta2, beta3, zeroRates4)
    ...
    print(beta1, beta2, beta3, zeroRates5)
