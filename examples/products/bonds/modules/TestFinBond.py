...
def test_FinBond():
    ...
    for accrualType in FinDayCountTypes:
        ...
        print("MATURITY", "COUPON", "CLEAN_PRICE", "ACCD_DAYS",
              "ACCRUED", "YTM")
        ...
        for index, bond in bondDataFrame.iterrows():
            ...
            print("%18s" % maturityDt, "%8.4f" % coupon,
