...
def test_FinCDSTranche():
    ...
    print("DATE")
    print(str((tradeDate)))
    print(str((stepInDate)))
    print(str((valuationDate)))
...
##########################################################################
    ...
    print("LABEL", "VALUE")
    print("INTRINSIC SPD TRANCHE MATURITY", intrinsicSpd)
    adjustedSpd = intrinsicSpd / 0.6
    print("ADJUSTED  SPD TRANCHE MATURITY", adjustedSpd)

    print("METHOD", "TIME", "NumPoints", "K1", "K2", "Sprd")
