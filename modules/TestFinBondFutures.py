...
def test_FinBondFuture():
    ...
    for bond in bonds:
        ...
        print(bond._maturityDate, bond._coupon * 100, cf)
    ...
    print("BOND MATURITY", "CF")
    for bond in bonds:
        cf = bondFutureContract.conversionFactor(bond)
        print(str(bond._maturityDate), cf)
    ...
    print(str(ctd._maturityDate), ctd._coupon)
