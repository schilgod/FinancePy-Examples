...
def loadHeterogeneousSpreadCurves(valuationDate, liborCurve):
    ...
    filename = root + "\\data\\CDX_NA_IG_S7_SPREADS.csv"
    ...
    for beta in [0.0, 0.5]:
        ...
        for ntd in range(1, numCredits + 1):
            for doF in [3, 10]:
                ...
                period = (end - start)
                print(period, numTrials, rho, doF, ntd, v[2] * 10000)
            ...
            print(period, numTrials, rho, "GC", ntd, v[2] * 10000)
    ...
    for beta in [0.0, 0.5]:
        ...
        for ntd in range(1, numCredits + 1):
            for numTrials in [1000]:
                ...
                period = (end - start)
                print(period, numTrials, rho, ntd, v[2] * 10000)
