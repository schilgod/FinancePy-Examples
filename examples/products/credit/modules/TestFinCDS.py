...
def test_CDSFastApproximation():
    ...
    for mktCoupon in np.linspace(0.000, 0.05, 21):
        ...
        print(mktCoupon * 10000, v_exact, v_approx, pctdiff)
...
def test_CDSCurveBuildTiming():
    ...
    print(str(numCurves) + " Libor curves", duration)
    ...
    duration = (end - start) / numCurves
    print(str(numCurves) + " Libor + CDS curves:", duration)
...
def test_fullPriceCDS():
    ...
    print("FULL_VALUE", v['full_pv'])
    print("CLEAN_VALUE", v['clean_pv'])
    ...
    print("FULL APPROX VALUE", v_approx[0])
