...
def test_FinVanillaOption():
    ...
    testCases.print("NUMPATHS", "VALUE_BS", "VALUE_MC", "TIME")
...
##########################################################################
    ...
    testCases.print("STOCK PRICE", "VALUE_BS", "VALUE_MC", "TIME")
...
##########################################################################
    ...
    testCases.print("STOCK PRICE", "VALUE_BS", "VOL_IN", "IMPLD_VOL")
