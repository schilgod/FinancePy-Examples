...
##########################################################################
    ...
    print("BETA1", "BETA2", "BETA3", "BETA4", "ZEROS")
    ...
    print(beta1, beta2, beta3, beta4, zeroRates1)
    ...
    print(beta1, beta2, beta3, beta4, zeroRates2)
    ...
    print(beta1, beta2, beta3, beta4, zeroRates3)
    ...
    print(beta1, beta2, beta3, beta4, zeroRates4)
    ...
    print(beta1, beta2, beta3, beta4, zeroRates5)
