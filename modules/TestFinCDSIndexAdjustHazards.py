...
def test_performCDSIndexHazardRateAdjustment():
    ...
    print("LABEL", "VALUE")
    print("AVERAGE SPD 3Y", averageSpd3Y)
    print("AVERAGE SPD 5Y", averageSpd5Y)
    print("AVERAGE SPD 7Y", averageSpd7Y)
    print("AVERAGE SPD 10Y", averageSpd10Y)
    print(
        "===================================================================")
    ...
    print("LABEL", "VALUE")
    print("INTRINSIC SPD 3Y", intrinsicSpd3Y)
    print("INTRINSIC SPD 5Y", intrinsicSpd5Y)
    print("INTRINSIC SPD 7Y", intrinsicSpd7Y)
    print("INTRINSIC SPD 10Y", intrinsicSpd10Y)
    print(
        "===================================================================")
...
#            print(m,str(cds._maturityDate),"%10.3f"%(unadjustedSpread*10000),"%10.3f" %(adjustedSpread*10000))
    ...
    print("LABEL", "VALUE")
    print("ADJUSTED INTRINSIC SPD 3Y", intrinsicSpd3Y)
    print("ADJUSTED INTRINSIC SPD 5Y", intrinsicSpd5Y)
    print("ADJUSTED INTRINSIC SPD 7Y", intrinsicSpd7Y)
    print("ADJUSTED INTRINSIC SPD 10Y", intrinsicSpd10Y)
