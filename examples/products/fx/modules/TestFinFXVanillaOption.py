...
#   Example from Hull 4th edition page 284
    ...
    for numPaths in numPathsList:
        ...
        duration = end - start
        print(numPaths, value, valueMC, duration)
...
##########################################################################
    ...
    print("NUMPATHS", "CALL_VALUE_BS", "CALL_VALUE_MC", "TIME")
...
##########################################################################
    ...
    print("SPOT FX RATE", "PUT_VALUE_BS", "PUT_VALUE_MC", "TIME")
    ...
    for spotFXRate in spotFXRates:
        ...
        duration = end - start
        print(spotFXRate, value, valueMC, duration)
...
##########################################################################
    ...
    for spotFXRate in spotFXRates:
        ...
        rho = 999
        print(spotFXRate, value, delta, vega, theta, rho)
...
##########################################################################
    ...
    for spotFXRate in spotFXRates:
        ...
        print(spotFXRate, value, volatility, impliedVol)
